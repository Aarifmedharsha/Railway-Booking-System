    ...
    if (!userFound()) {
      ...
      if (can_t != 1) {
        ...
        if (cancelled.contains(t_can)) {
          System.out.println(
              "This ticket is already cancelled!!If it is shown in booking details(It is for our side)Ticket is only booked if the ticket number is found in Seating Arrangements. ");
